...
public class Tutoria {
    ...
    public Tutoria(Docente profesor, Estudiante estudiante, Fecha fechaTutoria, Hora horaTutoria) {
        this.setProfesor(profesor);
        this.setEstudiante(estudiante);
        this.setFechaTutoria(fechaTutoria);
        this.setHoraTutoria(horaTutoria);
    }
    ...
    public String toString() {
        ...
        sb.append("Tutoria\n");
        sb.append("\tprofesor: ").append(getProfesor().toString());
        sb.append(",\n\testudiante: ").append(getEstudiante().toString());
        sb.append(",\n\tfechaTutoria: ").append(getFechaTutoria().toString());
        sb.append(",\thoraTutoria: ").append(getHoraTutoria().toString());
        sb.append('}');
        return sb.toString();
    }
